...
The coming-soon page for **payforspot.com**. One static HTML file, no build.
...
Domains → add `payforspot.com`**, then set the DNS records Render shows you.

## Edit

Everything is in `index.html` — the contact address near the bottom is a
placeholder (`hello@payforspot.com`); change it to a mailbox that exists
